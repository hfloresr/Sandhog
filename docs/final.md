...
$$x_{agent1_{t}}$$, $$x_{agent2_{t}}$$, $$x_{pig_{t}} \in \mathbb{X}^{2}$$, $$mathbb{X} = {0, 1, 2, 3, 4, 5, 6}$$

$$o_{agent1_{t}}$$, $$o_{agent2_{t}}$$, $$o_{pig_{t}} \in \mathbb{O}$$, $$mathbb{O} = {North, East, South, West}$$
