...
The learning algorithm can be described as the following:
  ...
  * **For** episode $$= 1, ... , M$$:
      ...
      * **For** $$t = 1, ..., T$$:
          * Select random action $$a_t$$ with probability $$\epsilon$$  (linear anneal $$\epsilon$$ policy)\\
...
<img src="pics/status_figs/meanq.png" align="middle" width="75%" height="75%">
...
<img src="pics/status_figs/acts_per_episode.png"  width="75%" height="75%">
...
<img src="pics/status_figs/max_reward.png" width="75%" height="75%">
...
<img src="pics/status_figs/min_reward.png" width="75%" height="75%">
...
<img src="pics/status_figs/reward_per_episode.png" width="75%" height="75%">
